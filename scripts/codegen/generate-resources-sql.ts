...
import { getInitialResources } from '../../src/data/resources/initialResources';
...
const outputPath = path.resolve(__dirname, '../sql/setup-resources.sql');
fs.writeFileSync(outputPath, sql.trim());
console.log('SQL generated at scripts/sql/setup-resources.sql');
