...
| 目录 | 文档 | 用途 |
|------|------|------|
| [engineering/](./engineering/) | [前端代码规范.md](./engineering/前端代码规范.md) | 工程规范 SSOT（Part A/B/C）；被 [AGENTS.md](../AGENTS.md) 与 [.cursor/rules/](../.cursor/rules/) 引用 |
| [product/](./product/) | [knowledge-prd.md](./product/knowledge-prd.md) | 碎片知识库产品需求（As-is / To-be） |
...
- **写代码前**：读 [engineering/前端代码规范.md](./engineering/前端代码规范.md)
- **看未完成项**：读 [product/project-status.md](./product/project-status.md)
- **改知识库**：读 [product/knowledge-prd.md](./product/knowledge-prd.md) + [product/knowledge-issues.md](./product/knowledge-issues.md)
- **初始化数据库**：执行 [setup/SupabaseSetup.sql](./setup/SupabaseSetup.sql)
