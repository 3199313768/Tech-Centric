...
import { STUDIO_QUICK_LINKS, type StudioStats } from '@/lib/studio/queries'

interface StudioDashboardProps {
  stats: StudioStats
}

export function StudioDashboard({ stats }: StudioDashboardProps) {
  const statItems = [
    ...
    <div className="sg-page sg-studio">
      ...
      <section className="sg-studio-note">
        ...
        <ul>
          ...
          <li>公开内容变更后：执行 `pnpm rag:index` 更新助手索引</li>
