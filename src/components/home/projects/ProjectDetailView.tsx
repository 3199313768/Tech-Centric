...
export function ProjectDetailView({ project }: ProjectDetailViewProps) {
  ...
  return (
    <article className="sg-page sg-project-detail">
      ...
      >
        <div className="sg-project-detail__hero-top">
        ...
        <div className="sg-project-detail__title-row">
          <h1>{project.name}</h1>
          <span className="sg-tag sg-project-detail__category">{project.category}</span>
        </div>
