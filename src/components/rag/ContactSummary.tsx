...
export function ContactSummary({ summary }: ContactSummaryProps) {
  return (
    <div className="mt-3 rounded-2xl border border-[var(--sg-green-light)]/15 bg-zinc-950/50 p-3 text-xs text-zinc-300">
      <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[var(--sg-green-light)]/70">Email Draft</p>
