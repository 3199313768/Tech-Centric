...
export function SourceList({ sources }: SourceListProps) {
  ...
  return (
    <div className="mt-4 space-y-2 border-t border-white/10 pt-3">
      <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-cyan-200/70">Sources</p>
        ...
        {sources.map((source) => {
          ...
          return (
            <SourceWrapper
              ...
              className="group rounded-2xl border border-white/10 bg-zinc-950/45 px-3 py-2 text-xs text-zinc-400 transition-all hover:border-cyan-300/35 hover:bg-cyan-300/10 hover:text-zinc-100"
            >
